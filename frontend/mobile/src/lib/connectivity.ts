/**
 * Conectividad del móvil (fase 14 · Offline): «¿puedo llegar al servidor?».
 ...
 * que el servidor ESCUCHA y las operaciones con servidor pueden intentarse.
 * Fuera de línea se re-sondea cada ~15 s para volver sola cuando llegue la
 * red; el banner global y la Venta leen este estado.
 */
